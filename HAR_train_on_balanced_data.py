...
print(f"point {0}  {cur_time}  {cur_time - start_time} ")
random_seed = 611
...
cur_time = datetime.datetime.now()
print(f"point {1}  {cur_time}  {cur_time - start_time} ")
...
cur_time = datetime.datetime.now()
print(f"point {2}  {cur_time}  {cur_time - start_time} ")
''' Main Code '''
# # # # # # # # # #   reading the data   # # # # # # # # # # 
# Path of file #
...
cur_time = datetime.datetime.now()
print(f"point {4}  {cur_time}  {cur_time - start_time} ")
...
cur_time = datetime.datetime.now()
print(f"point {5}  {cur_time}  {cur_time - start_time} ")
...
cur_time = datetime.datetime.now()
print(f"point {6}  {cur_time}  {cur_time - start_time} ")
...
cur_time = datetime.datetime.now()
print(f"point {9}  {cur_time} {cur_time - start_time} ")
